    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_logo', models.ImageField(default='company_logo/default.jpg', upload_to='company_logo/')),
                ('address', models.CharField(blank=True, max_length=30)),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('uploaded_at', models.DateTimeField(blank=True, null=True)),
                ('categories', models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, to='account.Category')),
