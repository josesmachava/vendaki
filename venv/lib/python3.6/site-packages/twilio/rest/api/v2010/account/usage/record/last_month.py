...
class LastMonthList(ListResource):
    ...
    def stream(self, category=values.unset, start_date=values.unset,
        ...
        :param LastMonthInstance.Category category: The usage category of the UsageRecord resources to read
...
class LastMonthInstance(InstanceResource):
    ...
    class Category(object):
        ...
        WIRELESS = "wireless"
        WIRELESS_ORDERS = "wireless-order"
        WIRELESS_ORDERS_ARTWORK = "wireless-order-artwork"
        WIRELESS_ORDERS_BULK = "wireless-order-bulk"
        WIRELESS_ORDERS_ESIM = "wireless-order-esim"
        WIRELESS_ORDERS_STARTER = "wireless-order-starter"
